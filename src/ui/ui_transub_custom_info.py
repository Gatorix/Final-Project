...
class Ui_SubCustomInfo(object):
    def setupUi(self, SubCustomInfo):
        ...
        SubCustomInfo.setMinimumSize(QSize(400, 450))
        SubCustomInfo.setMaximumSize(QSize(400, 450))
        self.layoutWidget = QWidget(SubCustomInfo)
        self.layoutWidget.setObjectName(u"layoutWidget")
        self.layoutWidget.setGeometry(QRect(230, 411, 158, 41))
